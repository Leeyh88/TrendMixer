                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
                            <div class="divide-y divide-gray-50">
                                <div v-for="post in posts.data" :key="post.id" class="p-6 hover:bg-indigo-50/20 transition-all group cursor-pointer">
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-grow min-w-0">
                                            <div class="flex items-center gap-2 mb-2">
                                                <span class="text-[10px] font-black text-indigo-500 uppercase tracking-widest">{{ getCategoryName(post.category) }}</span>
                                                <span class="w-1 h-1 bg-gray-200 rounded-full"></span>
                                                <span class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">{{ post.user.name }}</span>
                                            </div>
                    ...
                    <aside class="space-y-8">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <p class="text-2xl font-black italic">{{ posts.total }}</p>
                                    </div>
                                    <div>
                                        <p class="text-[9px] font-bold text-white/40 uppercase mb-1">Mixers</p>
                        ...
                        <div class="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-sm">
                            ...
                            <ul class="space-y-4">
                                ...
                                <li class="flex gap-3 items-start">
                                    <span class="w-1.5 h-1.5 bg-indigo-500 rounded-full mt-1.5"></span>
                                    <p class="text-[11px] font-bold text-gray-500 leading-relaxed">자신의 리믹스 작품 홍보는 '추천' 카테고리를 이용해주세요.</p>
                                </li>
                            </ul>
                        </div>
                    </aside>
