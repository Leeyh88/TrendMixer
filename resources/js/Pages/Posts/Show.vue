    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link :href="route('posts.index')" 
                      class="px-4 py-2 bg-white border border-gray-300 rounded-xl text-sm font-bold text-gray-600 hover:bg-gray-50 transition-all">
                    목록으로
                </Link>
            </div>
        </template>
        ...
        <div class="py-12 bg-gray-100 min-h-[calc(100vh-65px)]">
            <div class="max-w-4xl mx-auto px-4 space-y-8"> <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="flex flex-col items-center justify-center py-1 mt-1 border-t border-gray-50">
                        <button 
                            @click="toggleLike"
